    ...
    execute(client, message) {
        let button = new MessageActionRow().addComponents(
            ...
            .setCustomId("del"))
                ...
                .setFooter({ text: 'BardBot', iconURL:message.author.avatarURL({ dynamic: true }) })
                .setDescription(`**
            ...
            > Channels: \`${client.channels.cache.size}\`**`)
                        ...
                        button.reply({content: "Bot statistics updated", ephemeral: true}).catch(e => { });
                        ...
                        await Message.delete().catch(e => { });
                        button.reply({content: "Bot statistic deleted", ephemeral: true}).catch(e => { });
                        break
